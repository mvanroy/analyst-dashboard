...
.st-key-boys_log_toolbar [data-testid="stColumn"]:has(.st-key-bl_back_to_log){display:flex!important;align-items:flex-end!important;justify-content:center!important;}
