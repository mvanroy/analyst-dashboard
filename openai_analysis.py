...
def generate_dashboard_analysis(
    ...
    prompt = (
        ...
        "Support/resistance awareness: where relevant, maintain awareness of major support/resistance "
        "across the available timeframes, especially 1D levels. Use these levels to reason about entries, "
        "stops, exits, invalidation, and the trajectory of the selected-timeframe setup. Do not treat "
        "support/resistance as a mechanical veto; treat it as structural context that affects whether "
        "the setup is clean, conditional, late, capped, or invalid.\n\n"
