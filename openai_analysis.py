...
def generate_dashboard_analysis(symbol: str, api_key: str, model: str = DEFAULT_MODEL) -> dict:
    ...
    prompt = (
        ...
        "weaknesses, such as mixed context, imperfect entry, incomplete trigger, only decent R:R, or a meaningful "
        "caveat. C means a watchlist or tactical-only idea: plausible but early, late, aggressive, or requiring "
